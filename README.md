...
Open the interactive docs, expand POST /generate, click Try it out, and send:
...
(→ double-check every number against your actual training script before committing. These are from our notes; make them exact.)
